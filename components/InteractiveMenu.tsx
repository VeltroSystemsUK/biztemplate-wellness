          ...
          {visibleItems.map((item) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <span className="shrink-0 text-accent-400 font-mono font-bold text-base bg-accent-400/10 px-3 py-1 rounded-lg border border-accent-400/20">
                  {item.price}
                </span>
              </div>
              ...
              {item.tag && (
                <span className="self-start text-[10px] tracking-wider uppercase font-bold bg-accent-500/20 text-accent-300 px-2.5 py-1 rounded-md border border-accent-400/30">
                  {item.tag}
                </span>
              )}
            </div>
